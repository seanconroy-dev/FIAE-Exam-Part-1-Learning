...
id: ap1-0337
slug: warenannahme-verweigern-kriterien

# Display
title: "Kriterien zur Verweigerung der Warenannahme"

# Classification / navigation (machine-side)
module: "auftragsabwicklung-und-leistungserbringung"
topics: ["warenannahme", "lieferung", "maengel"]
tags: ["transportschaden", "falschlieferung", "wareneingang"]
...
- **Falsche Adressierung**
  → Die Lieferung ist nicht korrekt an den Empfänger adressiert.

- **Transportschäden**
  → Die Ware oder Verpackung ist sichtbar beschädigt.

- **Mengenabweichung**
  → Die Anzahl der gelieferten Packstücke stimmt nicht mit der Bestellung überein.
