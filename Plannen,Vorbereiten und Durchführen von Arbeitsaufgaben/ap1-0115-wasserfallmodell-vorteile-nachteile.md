...
id: ap1-0115
slug: wasserfallmodell-vorteile-nachteile
...
card:
  ...
  answer: |
    ...
    - Fortschritt leicht nachvollziehbar
    - Gute Einarbeitung neuer Teammitglieder

    Nachteile:
    - Keine Iterationen möglich
    - Anforderungen müssen früh vollständig definiert werden
    - Unflexibel bei Änderungen
    - Risiko, dass das Ergebnis nicht den tatsächlichen Anforderungen entspricht
  examples:
    - "Geeignet: Projekte mit klaren und stabilen Anforderungen"
    - "Ungeeignet: Projekte mit häufigen Änderungen oder unsicheren Anforderungen"
